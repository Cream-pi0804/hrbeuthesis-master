...
% \fi
  ...
  % 奇数页中间 (Center Odd)：显示章节标题
  \fancyhead[CO]{\song \wuhao \leftmark \rule[-2ex]{0pt}{0pt}}
  
  % 偶数页中间 (Center Even)：显示学校和论文类型
  % \fancyhead[CE]{\song \wuhao 哈尔滨工程大学\cxuewei 毕业论文}
  \fancyhead[CE]{\mbox{\normalfont\song \wuhao 哈尔滨工程大学\cxuewei 毕业论文\rule[-2ex]{0pt}{0pt}}}
  % 页脚中间：显示页码
  \fancyfoot[C]{\xiaowu --~\thepage~--}
  
  % 重新加上页眉线
  \renewcommand{\headrulewidth}{0pt} % 如果你用了自定义的 \makeheadrule，这里设为0
  \renewcommand{\headrule}{\makeheadrule} 
\else
  % --- 单面模式配置 (作为备选，防止报错) ---
  \fancyhf{}
  \fancyhead[C]{\song \wuhao 哈尔滨工程大学\cxuewei 毕业论文}
  \fancyfoot[C]{\xiaowu --~\thepage~--}
\fi
...
\def\makecover{
    ...
    \parbox[t][0.8cm][t]{\textwidth}{\hei \wuhao \hfill 密~~~~~~级：\underline{\makebox[\lengthofxuehao][c]{公开}}~~~}  % \lengthofxuehao 决定了一个空横线的长度，本科论文的密级留空，即使填写，密级也比学号短，故使用学号长度
    \end{center}
    ...
    \parbox[t][1.0cm][t]{\textwidth}{
      \xiaosan
      \makebox[3.0cm][c]{}
      \makebox[4.0cm][l]{\song 学院（系）名称：}  % 这里用 l 比用 s 效果好，扉页则不是，奇怪
    ...
    \parbox[t][2cm][t]{\textwidth}{
      \xiaoyi
      \begin{center}{\hei Design and Development of an Underwater Cable-Driven Robotic Arm}\end{center}
    }
    \ifxueweidoctor  % TODO: 将来的事
    \parbox[t][3.9cm][t]{\textwidth}{
      \erhao  % 英文标题太长时可以采用\xiaoer
    ...
    \parbox[t][1.0cm][t]{\textwidth}{
      \xiaosan
      \makebox[3.0cm][c]{}
      \makebox[4.0cm][l]{\hei 学~~生~~~~名~~称：}  % 这里用 l 比用 s 效果好，扉页则不是，奇怪
      \makebox[7cm][l]{\song 倪洪运}
    }
    \parbox[t][1.0cm][t]{\textwidth}{
      \xiaosan
      \makebox[3.0cm][c]{}
      \makebox[4.0cm][l]{\hei 所~~在~~~~学~~院：}
      \makebox[7cm][l]{\song 机电工程学院}

    }
    \parbox[t][1.0cm][t]{\textwidth}{
      \xiaosan
      \makebox[3.0cm][c]{}
      \makebox[4.0cm][l]{\hei 所~~在~~~~专~~业：}
      \makebox[7cm][l]{\song \@csubject}
    }
    \parbox[t][1.0cm][t]{\textwidth}{
      \xiaosan
      \makebox[3.0cm][c]{}
      \makebox[4.0cm][l]{\hei 指~~导~~~~教~~师：}
      \makebox[7cm][l]{\song 刘星}
    }

    \parbox[t][1.0cm][t]{\textwidth}{
      \xiaosan
      \makebox[3.0cm][c]{}
      \makebox[4.0cm][l]{\hei 职~~~~~~~~~~~~~~~~称：}
      \makebox[7cm][l]{\song 副教授}
    }
    \parbox[t][1.0cm][t]{\textwidth}{
      \xiaosan
      \makebox[3.0cm][c]{}
      \makebox[4.0cm][l]{\hei 所~~在~~~~单~~位：}
      \makebox[7cm][l]{\song 哈尔滨工程大学}
    }
    \parbox[t][1.0cm][t]{\textwidth}{
      \xiaosan
      \makebox[3.0cm][c]{}
      \makebox[4.0cm][l]{\hei 论文提交日期：}
      \makebox[7cm][l]{\song 2024年5月25日}
    }
    \parbox[t][1.0cm][t]{\textwidth}{
      \xiaosan
      \makebox[3.0cm][c]{}
      \makebox[4.0cm][l]{\hei 论文答辩日期：}
      \makebox[7cm][l]{\song 2024年6月11日}
    }
    \parbox[t][1.0cm][t]{\textwidth}{
      \xiaosan
      \makebox[3.0cm][c]{}
      \makebox[4.0cm][l]{\hei 学位授予单位：}
      \makebox[7cm][l]{\song 哈尔滨工程大学}
    }
    % \parbox[t][2.1cm][t]{\textwidth}{
    %   \begin{center} \end{center}
    ...
    % \parbox[t][1.2cm][t]{\textwidth}{\xiaoer
    % \begin{center}{哈尔滨工程大学}\end{center} }
    % \parbox[t][0.5cm][t]{\textwidth}{
    % \begin{center}{\song \xiaoer \@cdate} \end{center} }
