...
% \usepackage{amsmath}
\usepackage{etex}
\usepackage[skip=0pt]{caption}   % 同时设置标题上下间距为 10pt
\usepackage{listings}
...
\lstset{
    ...
    lineskip=2pt,
    breaklines=true,            % 自动换行（极其重要，否则长代码会超出页面）
    frame=single,               % 给代码加个单线边框
    numbers=left,               % 在左侧显示行号
    keywordstyle=\color{blue},  % 关键字变蓝
    commentstyle=\color{green!50!black}, % 注释变绿
...
%
\ifxueweibachelor
  \usepackage[top=48mm, bottom=40mm, left=25mm, right=25mm, % 左右统一
              headheight=7mm, headsep=3mm, footskip=7mm,
              hmarginratio={1:1} % 强制 1:1 比例
              ]{geometry}
\fi
\ifxueweimaster % TODO
