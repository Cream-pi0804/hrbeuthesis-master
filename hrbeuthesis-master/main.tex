...
\makeatletter
\newcommand{\WidenAppendixTOC}{
    % 在原本的 \@dottedtocline 前面，加了一个 \vspace 控制垂直间距
    \renewcommand*\l@section{\vspace{8pt}\@dottedtocline{1}{1.5em}{4.5em}}
    \renewcommand*\l@section{\vspace{8pt}\@dottedtocline{2}{1.5em}{2.0em}}
}
\makeatother
...
% \setlength{\headheight}{25pt} % 15pt 通常够用，如果还重叠可以改成 18pt 或 20pt
% 文档开始
\setlength{\headheight}{23pt} 
\addtolength{\topmargin}{-3.1pt}
\begin{document}
